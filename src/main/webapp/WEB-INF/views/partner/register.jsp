        ...
        <div class="container-fluid pt-4 px-4">
            <div class="form-section bg-light rounded p-5">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <h4 class="mb-0">거래처 등록</h4>
                </div>
                <form id="partnerRegisterForm">
                    <div class="row mb-4">
                        <div class="col-md-6">
                            <label class="form-label">거래처코드</label>
                            <input type="text" class="form-control" name="partnerId" placeholder="예: PART001" required>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">담당자ID(사원번호)</label>
                            <input type="text" class="form-control" name="empid" placeholder="예: EMP001" required>
                        </div>
                    </div>
                    <div class="row mb-4">
                        <div class="col-md-6">
                            <label class="form-label">거래처명</label>
                            <input type="text" class="form-control" name="partnerName" placeholder="거래처명을 입력하세요" required>
                        </div>
                        <div class="col-md-6">
...
<script>
$(function() {
    $('#partnerRegisterForm').on('submit', function(e) {
        e.preventDefault();
        var param = {
        ...
        $.ajax({
            url: "${pageContext.request.contextPath}/partner/add",
            method: "POST",
