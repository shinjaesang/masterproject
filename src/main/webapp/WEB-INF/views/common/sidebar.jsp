	...
	<nav class="navbar bg-light navbar-light">
		...
		<div class="navbar-nav w-100">
			...
			<div class="nav-item dropdown">
				...
				<div class="dropdown-menu bg-transparent border-0">
					<a href="${pageContext.request.contextPath}/inventory/currentInventory.do"
			...
			<div class="nav-item dropdown">
				...
				<div class="dropdown-menu bg-transparent border-0">
					<a href="${pageContext.request.contextPath}/statistics/top-sales.do"
						...
						href="${pageContext.request.contextPath}/report/inout/stat.do"
			...
			<div class="nav-item dropdown">
				...
				<div class="dropdown-menu bg-transparent border-0">
					<a href="${pageContext.request.contextPath}/authority/list.do"
						class="dropdown-item">권한 관리</a>
				</div>
			</div>
