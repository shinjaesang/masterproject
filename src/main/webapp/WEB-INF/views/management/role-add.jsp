...
<head>
    <meta charset="utf-8">
    <title>Stockmaster - 새 역할 추가</title>
...
<body>
                            ...
                            <form id="roleForm">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="d-flex align-items-center mb-2">
                                        <span id="selectedUserCount" class="me-2">선택된 사용자: 0명</span>
                                        <button type="button" class="btn btn-primary btn-user-edit" onclick="openUserEdit()">
                                            <i class="fas fa-users me-2"></i>사용자 추가
                                        </button>
                                    </div>
                                </div>
                                <div class="mb-3">
                                    ...
                                    <div class="permission-section">
                                        ...
                                        <div class="permission-group">
                                            ...
                                            <div class="form-check mb-2">
                                                <input class="form-check-input" type="checkbox" name="permissions" value="PARTNER_EDIT" id="partnerEdit">
                                                <label class="form-check-label" for="partnerEdit">거래처 등록/수정</label>
                                            </div>
                                            <div class="form-check mb-2">
                                                <input class="form-check-input" type="checkbox" name="permissions" value="PARTNER_DELETE" id="partnerDelete">
                                        ...
                                        <div class="permission-group">
                                            ...
                                            <div class="form-check mb-2">
                                                <input class="form-check-input" type="checkbox" name="permissions" value="APPROVAL_EDIT" id="approvalEdit">
                                                <label class="form-check-label" for="approvalEdit">결재문서 작성/수정/회수</label>
                                            </div>
                                            <div class="form-check mb-2">
                                                <input class="form-check-input" type="checkbox" name="permissions" value="APPROVAL_PROCESS" id="approvalProcess">
                                        ...
                                        <div class="permission-group">
                                            ...
                                            <div class="form-check mb-2">
                                                <input class="form-check-input" type="checkbox" name="permissions" value="NOTICE_EDIT" id="noticeEdit">
                                                <label class="form-check-label" for="noticeEdit">공지사항 작성/수정/삭제</label>
                                            </div>
                                            <div class="form-check mb-2">
                                                <input class="form-check-input" type="checkbox" name="permissions" value="NOTICE_EMERGENCY" id="noticeEmergency">
                                        ...
                                        <div class="permission-group">
                                            ...
                                            <div class="form-check mb-2">
                                                <input class="form-check-input" type="checkbox" name="permissions" value="PRODUCT_EDIT" id="productEdit">
                                                <label class="form-check-label" for="productEdit">상품 등록/수정</label>
                                            </div>
                                            <div class="form-check mb-2">
                                                <input class="form-check-input" type="checkbox" name="permissions" value="PRODUCT_DELETE" id="productDelete">
                                        ...
                                        <div class="permission-group">
                                            ...
                                            <div class="form-check mb-2">
                                                <input class="form-check-input" type="checkbox" name="permissions" value="INVENTORY_SLIP_EDIT" id="inventorySlipEdit">
                                                <label class="form-check-label" for="inventorySlipEdit">입출고 전표 등록/수정</label>
                                            </div>
                                            <div class="form-check mb-2">
                                                <input class="form-check-input" type="checkbox" name="permissions" value="INVENTORY_SLIP_DELETE" id="inventorySlipDelete">
                                        ...
                                        <div class="permission-group">
                                            ...
                                            <div class="form-check mb-2">
                                                <input class="form-check-input" type="checkbox" name="permissions" value="STOCK_ADJUST" id="stockAdjust">
                                        ...
                                        <div class="permission-group">
                                            ...
                                            <div class="form-check mb-2">
                                                <input class="form-check-input" type="checkbox" name="permissions" value="WAREHOUSE_EDIT" id="warehouseEdit">
                                                <label class="form-check-label" for="warehouseEdit">창고 등록/수정</label>
                                            </div>
                                            <div class="form-check mb-2">
                                                <input class="form-check-input" type="checkbox" name="permissions" value="WAREHOUSE_DELETE" id="warehouseDelete">
                                        ...
                                        <div class="permission-group">
                                            <h6 class="mb-3">기타</h6>
                                            <div class="form-check mb-2">
                                                <input class="form-check-input" type="checkbox" name="permissions" value="ACCOUNT_MANAGE" id="accountManage">
                                                <label class="form-check-label" for="accountManage">계정 관리</label>
                                            </div>
                                            <div class="form-check mb-2">
                                                <input class="form-check-input" type="checkbox" name="permissions" value="SALES_VIEW" id="salesView">
                                                <label class="form-check-label" for="salesView">매출 정보 조회</label>
                                            </div>
                                            <div class="form-check mb-2">
                                                <input class="form-check-input" type="checkbox" name="permissions" value="EMERGENCY_CONTACT" id="emergencyContact">
                                                <label class="form-check-label" for="emergencyContact">비상연락망 수정</label>
                                            </div>
                                            <div class="form-check mb-2">
                                                <input class="form-check-input" type="checkbox" name="permissions" value="USER_INFO_EDIT" id="userInfoEdit">
    ...
    <script>
        ...
        function openUserEdit() {
            ...
            window.open('${pageContext.request.contextPath}/authority/roleuseredit.do', 
                       '사용자 선택', 
        ...
        function saveRole() {
            ...
            // AJAX 요청
            $.ajax({
                url: '${pageContext.request.contextPath}/authority/role/add.do',
                type: 'POST',
                contentType: 'application/json',
                data: JSON.stringify(formData),
                success: function(response) {
                    alert('역할이 성공적으로 추가되었습니다.');
