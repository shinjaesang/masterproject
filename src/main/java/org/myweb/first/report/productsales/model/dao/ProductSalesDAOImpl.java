...
public class ProductSalesDAOImpl implements ProductSalesDAO {
    ...
    public List<ProductSalesDTO> selectProductSalesList(Map<String, String> params) {
        return sqlSession.selectList("org.myweb.first.report.productsales.model.dao.ProductSalesDAO.selectProductSalesList", params);
    }

    @Override
    public ProductSalesSummaryDTO selectProductSalesSummary(Map<String, String> params) {
        return sqlSession.selectOne("org.myweb.first.report.productsales.model.dao.ProductSalesDAO.selectProductSalesSummary", params);
    }
} 