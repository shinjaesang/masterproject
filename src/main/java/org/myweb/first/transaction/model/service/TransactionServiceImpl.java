...
public class TransactionServiceImpl implements TransactionService {
	...
	/*
	 * private static final String API_URL = "https://invoicing.co/api/v1/invoices";
	 * // Invoice Ninja API 엔드포인트 private static final String API_TOKEN =
	 * "YOUR_API_TOKEN"; // 발급받은 API 토큰
	 * 
	 * public String getInvoices() throws Exception { CloseableHttpClient client =
	 * HttpClients.createDefault(); HttpGet request = new HttpGet(API_URL);
	 * request.setHeader("X-Ninja-Token", API_TOKEN); request.setHeader("Accept",
	 * "application/json");
	 * 
	 * try (CloseableHttpResponse response = client.execute(request)) { String
	 * jsonResponse = EntityUtils.toString(response.getEntity()); return
	 * jsonResponse; }
	 * 
	 * }
	 */
